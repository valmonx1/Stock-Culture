...
setView("register");
document.querySelector("#view-register h1").textContent = "Edit QC organism";
document.querySelector("#view-register .page-heading p").textContent = "Update the organism record while keeping the original traceability and acceptance history.";
document.querySelector("#view-register .record-reference").innerHTML = "Editing <strong>QC-2026-004</strong>";
document.querySelector('#register-form button[type="submit"]').innerHTML = "Save changes <span class=\"button-symbol\">→</span>";
const editIdField = document.querySelector('#register-form [name="organismId"]');
if (editIdField) editIdField.value = "QC-2026-004";
const PAGE_LINKS = { dashboard: "Main_Page.html", register: "Register_QC.html", edit: "Edit_QC_Organism.html", detail: "Organism_Detail.html", acceptance: "Acceptance_Testing.html", storage: "Storage_Map.html", passages: "Passage_Log.html", subculture: "Subculture.html", usage: "Usage_Disposal.html" };
